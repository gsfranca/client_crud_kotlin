...
fun ItemEntryBody(
    ...
    Column(
        ...
        Button(
            ...
            Text(text = stringResource(R.string.save_client))
        }
    }
}
...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text(
                    text = stringResource(R.string.item_name_req),
        ...
        OutlinedTextField(
            ...
            placeholder = {
                Text(
                    text = stringResource(R.string.item_email_req),
                    color = Color(0x80FFFFFF)
                )
            },
            colors = OutlinedTextFieldDefaults.colors(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.item_phonenumber_req)) },
            placeholder = {
                Text(
                    text = stringResource(R.string.item_phonenumber_req),
                    color = Color(0x80FFFFFF)
                )
            },
            colors = OutlinedTextFieldDefaults.colors(
...
private fun ItemEntryScreenPreview() {
    InventoryTheme {
        ItemEntryBody(itemUiState = ItemUiState(
            ItemDetails(
                name = "Oscar", email = "OscarP@gmail.com", phonenumber = "+61 2 1234-5678"
            )
